...
export default function Title() {
  ...
  return (
    <Stack sx={{ flexDirection: 'row', gap: '10px' ,marginTop:'40px'}}>
    ...
    <Stack>  
        ...
        <Typography variant="h4">{theTitle.title}
        ...
        <Typography variant="h6" sx={{ opacity: 0.7 }}>{theTitle.description}  </Typography>
        </>
    }
